...
export const ASSISTANT_TIPS = [
  ...
  { brand: 'hp', model: 'mfpe52645', text: 'Atolamento frequente no E52645 pode indicar rolo de puxada desgastado. Kit Tray 2: RM2-5752-000CN. Kit Tray 1: F2A68-67914.' },
  { brand: 'hp', model: 'mfpe52645', text: 'Antes de limpar um atolamento no E52645, anote o código de erro completo (ex.: 13.02.00) para diagnóstico.' },
  ...
  { brand: 'hp', model: 'mfpe52645', text: 'Cartuchos compatíveis no E52645 podem acionar alarme de "cartucho não HP". Use CF287A para resultado garantido.' },
  ...
  { brand: 'hp', model: 'mfpe52645', text: 'O fusor do E52645 é monitorado por rotações, não por páginas. Para manutenção preventiva, use o kit de rolos ADF (W5U23-67901) e kit de rolos Tray 2 (RM2-5752-000CN) conforme indicação do contador.' },
  ...
  { brand: 'hp', model: 'mfpe52645', text: 'Impressão com riscos verticais no E52645? O cartucho CF287A integra tambor e toner — troque o cartucho completo. Nunca toque na superfície do tambor OPC.' },
  ...
  { brand: 'hp', model: 'mfpe62655', text: 'ADF do E62655 com falhas de alimentação? Use o kit de manutenção do ADF 5851-3580 ou o kit de rolos 5851-6707.' },
  ...
  { brand: 'hp', model: 'mfpe62655', text: 'Erro 50.x Fuser no E62655 indica falha no fusor. Desligue, aguarde 10 min e verifique o conector; persistindo, troque o kit J8J87A/J8J88A.' },
  ...
  { brand: 'hp', model: 'mfpe62655', text: 'Riscos verticais no E62655? O tambor é integrado ao W9004MC — substitua o cartucho completo se o defeito acompanhar a página.' },
