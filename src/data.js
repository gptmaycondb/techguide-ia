...
export const MANUALS_RICOH = [
  ...
  },
  {
    ...
    brand: 'ricoh',
    label: 'MP 2555',
    subtitle: 'Ricoh MP 2555/3055/3555 Series - A3 Mono',
    color: '#e63946',
    indexKey: 'ricoh_mp2555_guia',
    searchKeys: ['ricoh_mp2555_service', 'ricoh_mp2555_guia'],
    tags: ['MP 2555', 'A3', 'Mono', 'MFP'],
    topics: {
      user: {
        'Uso Diario': [
          'Como colocar papel na Ricoh MP 2555?',
          'Como imprimir dos dois lados?',
          'Como digitalizar um documento?',
          'O papel atolou, o que faco?',
          'A impressora nao liga',
        ...
        'Suprimentos': [
          'Como trocar o toner da MP 2555?',
          'Como verificar o nivel do toner?',
          'Como substituir o cilindro?',
          'Como fazer manutencao preventiva?',
        ],
        'Conexao': [
          'Como configurar digitalizar para pasta?',
          'Nao consigo imprimir da rede',
          'Como configurar digitalizar para email?',
          'Como acessar o Web Image Monitor?',
        ],
        'Mensagens': [
          'O que significa a mensagem no painel?',
      ...
      tech: {
        ...
        'Suprimentos': [
          'Substituir toner da serie MP 2555/3055/3555',
          'Substituir unidade de cilindro',
          'Intervalos de manutencao',
          'Diagnosticar qualidade de impressao',
        ],
        'Rede': [
          'Configurar IP estatico',
          'Acessar Web Image Monitor',
        ...
        'Service': [
          ...
          'Substituir unidade de fusao',
          'Diagnosticar alimentacao de papel',
          'Ajustes e testes de servico',
        ],
      },
    },
    prompts: {
      user: 'Voce e um assistente de suporte para usuarios da serie Ricoh MP 2555/3055/3555, multifuncional A3 monocromatica. Baseie a resposta nos TRECHOS DO MANUAL fornecidos, de forma clara e completa o suficiente para o usuario resolver o problema passo a passo. Apresente o defeito, as causas e a solucao quando os trechos trouxerem. Nao invente informacoes. Pode acrescentar orientacoes gerais verdadeiras marcando como (Complemento). Se o manual nao tiver a resposta, informe isso. Portugues Brasileiro.',
      tech: 'Voce e um tecnico especialista na serie Ricoh MP 2555/3055/3555, multifuncional A3 monocromatica. Baseie sua resposta nos TRECHOS DO MANUAL fornecidos e apresente TODAS as informacoes relevantes deles - nao resuma demais. Organize o diagnostico em: Defeito ou condicao, Possiveis causas, Solucao passo a passo e Pecas/ajustes quando houver. Pode acrescentar conhecimento tecnico adicional APENAS se for verdadeiro e diretamente relacionado, marcando como (Complemento). NUNCA invente codigos, valores de SP, tensoes, part numbers ou procedimentos que nao estejam nos trechos. Se os trechos nao trouxerem a solucao completa, apresente o que existe e informe que o restante deve ser consultado no service manual fisico. Portugues Brasileiro.',
    },
  },
  {
    id: 'ricoh_mp3055',
    ...
    indexKey: 'ricoh_mp2555_guia',
    searchKeys: ['ricoh_mp2555_service', 'ricoh_mp2555_guia'],
    tags: ['MP 3055', 'A3', 'Mono', 'MFP'],
    topics: {
      user: {
        'Uso Diario': [
          'Como colocar papel na Ricoh MP 3055?',
          'Como imprimir dos dois lados?',
          'Como digitalizar um documento?',
          'O papel atolou, o que faco?',
          'A impressora nao liga',
        ...
        'Suprimentos': [
          'Como trocar o toner da MP 3055?',
          'Como verificar o nivel do toner?',
          'Como substituir o cilindro?',
          'Como fazer manutencao preventiva?',
        ],
  ...
  },
  {
    ...
    indexKey: 'ricoh_mp2555_guia',
    searchKeys: ['ricoh_mp2555_service', 'ricoh_mp2555_guia'],
    tags: ['MP 3555', 'A3', 'Mono', 'MFP'],
    topics: {
      user: {
        'Uso Diario': [
          'Como colocar papel na Ricoh MP 3555?',
          'Como imprimir dos dois lados?',
          'Como digitalizar um documento?',
          'O papel atolou, o que faco?',
          'A impressora nao liga',
        ...
        'Suprimentos': [
          'Como trocar o toner da MP 3555?',
          'Como verificar o nivel do toner?',
          'Como substituir o cilindro?',
          'Como fazer manutencao preventiva?',
        ],
...
export const BRAND_GROUPS = [
  ...
  },
  {
    ...
    models: [
      ...
      {
        id: 'ricoh_mp2555_group',
        label: 'MP 2555',
        subtitle: 'Ricoh MP 2555 - A3 Mono',
        color: '#e63946',
        icon: '\uD83D\uDDA8\uFE0F',
        manuals: [
          {
            id: 'ricoh_mp2555_guia',
            title: 'Guia do Usuario',
            subtitle: 'Manual de operacao MP 2555/3055/3555',
            desc: 'Operacao, configuracao e solucao de problemas',
            color: '#e63946',
            icon: '\uD83D\uDCD5',
            tags: ['Guia', 'MP 2555', 'MP 3055', 'MP 3555', '4.8 MB'],
            url: 'https://drive.usercontent.google.com/download?id=1MMafv99blqQOM5xtTzm9szWY-JFQ0P7K&export=download&confirm=t',
            localName: 'tg_ricoh_guia_mp2555.pdf',
            size: '4.8 MB',
          },
          {
            id: 'ricoh_mp2555_service',
            title: 'Service Manual',
            subtitle: 'Manual de servico tecnico MP 2555/3055/3555',
            desc: 'Diagnostico, reparo, ajustes e procedimentos de servico',
            color: '#ff6b35',
            icon: '\uD83D\uDD27',
            tags: ['Service', 'MP 2555', 'MP 3055', 'MP 3555', '73 MB'],
            url: 'https://drive.usercontent.google.com/download?id=1I8GbZBlvywJcmlgwrIphlUjuGiUq2KID&export=download&confirm=t',
            localName: 'tg_ricoh_service_mp2555.pdf',
            size: '73 MB',
          },
          {
            // Somente consulta (download) - nao entra na busca do chat (searchKeys/indice)
            id: 'ricoh_mp2555_parts_catalog',
            title: 'Parts Catalog',
            subtitle: 'Catalogo de pecas MP 2555/3055/3555',
            desc: 'Part numbers e diagramas de montagem - somente consulta',
            color: '#f59e0b',
            icon: '\uD83D\uDCE6',
            tags: ['Parts Catalog', 'MP 2555', 'MP 3055', 'MP 3555', '11.3 MB'],
            url: 'https://drive.usercontent.google.com/download?id=1kfyZ3B4amoGr0Xj4LThg2yjAbis1AqVB&export=download&confirm=t',
            localName: 'tg_ricoh_parts_catalog_mp2555.pdf',
            size: '11.3 MB',
          },
        ],
      },
      {
        id: 'ricoh_mp3055_group',
        label: 'MP 3055',
        subtitle: 'Ricoh MP 3055 - A3 Mono',
        color: '#e63946',
        icon: '\uD83D\uDDA8\uFE0F',
        manuals: [
          {
            id: 'ricoh_mp3055_guia',
            title: 'Guia do Usuario',
            subtitle: 'Manual de operacao MP 2555/3055/3555',
            desc: 'Operacao, configuracao e solucao de problemas',
            color: '#e63946',
      ...
      {
        id: 'ricoh_mp3555_group',
        label: 'MP 3555',
        subtitle: 'Ricoh MP 3555 - A3 Mono',
        color: '#e63946',
        icon: '\uD83D\uDDA8\uFE0F',
        manuals: [
          {
            id: 'ricoh_mp3555_guia',
            title: 'Guia do Usuario',
            subtitle: 'Manual de operacao MP 2555/3055/3555',
            desc: 'Operacao, configuracao e solucao de problemas',
            color: '#e63946',
